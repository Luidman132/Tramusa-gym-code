    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-md overflow-hidden border border-transparent dark:border-slate-800">
        ...
        <div className="p-6 space-y-4">
          <div>
            <label className="block text-sm text-slate-600 dark:text-slate-400 mb-1.5">Descripción</label>
            <input
              type="text"
              value={titulo}
          ...
          {plan !== '' && (
            <div>
              <label className="block text-sm text-slate-600 dark:text-slate-400 mb-1.5">Tipo de Plan</label>
          ...
          {monto !== '' && (
            <div>
              <label className="block text-sm text-slate-600 dark:text-slate-400 mb-1.5">Monto Cobrado</label>
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 dark:text-slate-400 font-bold">S/</span>
                <input
                  type="number"
                  value={monto}
        ...
        <div className="p-6 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors"
          >
            <Trash2 size={16} />
            Eliminar Registro
          </button>
